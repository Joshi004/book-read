---
title: "The Time-Distance Problem of Influence"
chapter: 3
book: "Behavior Ops"
author: "Charles Huge"
---
...
![Figure 3.1 — The Time-Distance Graph. The red circle marks where most modern experts operate. The green circle marks the goal: major behavioral change in minimal time. The gray dashed arrow is the Missing Bridge.](../assets/diagrams/chapter03_time_distance.png)
...
```mermaid
flowchart TD
    A["🔴 Low Distance\nTrying a restaurant you've never been to\n(A behavior that would not otherwise have occurred)"]
    B["🟡 Mid Distance\nBuying a car you can't afford"]
    C["🟠 Upper Distance\nJoining a cult or committing a small crime"]
    D["🔴 Extreme Distance\nCommitting treason — or stopping\nself-destructive actions and thoughts"]
...
sequenceDiagram
    ...
    P->>S: CrossFade — intentionally confusing language,<br/>hypnosis techniques, unusual speaking pattern
    Note over S: Subject enters "blank slate" state
    S-->>P: Dramatically increased receptivity
    Note over P,S: Behavioral change achieved in ≤ 10 minutes
```
