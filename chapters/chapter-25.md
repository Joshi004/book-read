...
chapter: 25
subtitle: "Reading Behavior, Rating Deception, and the Anatomy of a Cell"
book: "Behavior Ops"
author: "Charles Huge"
---
...
```mermaid
sequenceDiagram
    participant Q as Interrogator
    participant S as Mr. Phillips

    Note over Q,S: BEFORE — question is asked
    Q->>S: "What happened when you were with Carl Williams in your car last week?"
    Note over S: DF (Digital Flexion) + KC (Knee Clasping) — a group, before he even speaks

    Note over Q,S: DURING — the response
    S->>Q: "I'm a well-respected member of this community... I did not do anything."
    Note over S: Resume statement · non-contracted denial · SS · head shake (No) · palm exposure

    Note over Q,S: Group scored — total 17.5
```
