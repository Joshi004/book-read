---
title: "The 6 Axis Model of Influence"
chapter: 5
book: "Behavior Ops"
author: "Charles Huge"
---
...
![Figure 5.1 — The 6 Axis Model of Influence. Each vertex represents one of the six factors that drive persuasion. Only three need to be present in high measure for influence to occur.](../assets/diagrams/chapter05_6axis_model.svg)
...
```mermaid
flowchart LR
    subgraph active["✅ Active — High Measure"]
        F["Focus\nhyperfocused via authority\n& situational novelty"]
        S["Suggestibility\nheightened by\nauthority presence"]
        C["Compliance\ndriven by ancestral\nauthority script"]
    end
    subgraph inactive["⚫ Inactive — Low / Absent"]
        CN["Connection\nno relationship with\nexperimenter or subjects"]
        O["Openness\nnot vulnerable about\ntrue feelings"]
        E["Expectancy\nlittle positive anticipation\nor future prediction"]
    end
